...
describe('parseWindow', () => {
  ...
  test('rejects an unrecognized unit', () => expect(() => parseWindow('bogus')).toThrow());
  test('rejects a missing unit', () => expect(() => parseWindow('24')).toThrow());
});
...
describe('parsePolicy', () => {
  ...
  test('rejects an unreachable escalate branch (threshold above cap)', () => {
    const bad = { ...base, spend_cap_rupees: '500.00', approval_threshold_rupees: '1000.00' };
